...
that {\tt int size} really be a {\tt size\_t}?
...
mutation tools, acts as a very limited version of Epsilon's hypothetical
``bugginator.''

\section{Postscript to the Postscript}

During the final preparation of the test harnesses for this essay, the
author ran into a bug (in the test harness) that required 4 CS PhDs
from one of the top computer science schools in the world about 15
minutes to figure out.  So it goes.
