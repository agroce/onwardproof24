...
meaning that Delta finally compromises on is based on a Popperian falsification methodology proposed in
...
for testing and proving them using CBMC~\cite{CBMCp} and DeepState~\cite{goodman2018deepstate}, can be found at \url{https://github.com/agroce/onward24code}.
